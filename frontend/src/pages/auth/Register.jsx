            ...
            <div className={s.container}>
                <div className={s.formCard}>
                        ...
                        <div>
                            ...
                            <div style={{ position: "relative" }}>
                                <input type={showPassword ? "text" : "password"} name='password' placeholder='******'
                                    value={formData.password} onChange={handleChange} required className={s.input}
                            ...
                            <div className={s.roleContainer}>
                                <label className={`${s.roleLabelBase} ${formData.role === "buyer" ? s.roleLabelActive : s.roleLabelInactive}`}>
                                    <input type="radio" name='role' value="buyer" checked={formData.role === "buyer"}
                                        onChange={handleChange} className={s.hiddenRadio}
                                    />
                                    Buyer
                                </label>
                    ...
                    <p className={s.footerText}>
                        ...
                        <Link to='/login' className={s.loginLink}>Sign in here</Link>
                    </p>
                </div>
            </div>
        </div>
