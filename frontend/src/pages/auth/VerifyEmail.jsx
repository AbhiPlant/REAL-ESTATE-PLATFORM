...
const VerifyEmail = () => {
    ...
    // to get email passed from registerPage
                ...
                <div className={s.card}>
                    ...
                    <form onSubmit={handleSubmit} className={s.form}>
                        ...
                        <div>
                            ...
                            <input type="text" maxLength="6" placeholder='123123' value={code}
                            onChange={(e) => setCode(e.target.value)} required className={s.codeInput} />
                        </div>
