                ...
                <div className={s.containerPy12TextCenter}>
                    <div className={s.cardPremiumPy16Px8}>
                        ...
                        <button onClick={() => window.location.reload()}
                            className={s.btnPrimary}>Try Again</button>
                    </div>
                </div>
            </div>
        );
            ...
            <div className={`${s.containerFadeIn} ${user?.role !== "seller" ? s.py12Pt12 : s.pt0
                ...
                <div className={s.mb12}>
                    ...
                    <p className={s.textMuted}>
                        {isSeller ? "Review and Response to interest in your properties"
                            : "Tract the status of your property inquiries."}
                    </p>
                </div>
                ...
                {inquiries.length === 0 ? (
                    <div className={s.cardPremiumPy24Px8TextCenter}>
                        ...
                        <p className={s.textMutedMb8}>
                            {isSeller ? "You haven't received and inquiries yet. Better listing get more attention.!"
