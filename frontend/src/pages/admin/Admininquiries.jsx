...
const Admininquiries = () => {
    ...
    // to fetch the inquiries raised by the buyers to seller
    useEffect(() => {
        const fetchInquiries = async () => {
            if (!token) return;
            setLoading(true);
            try {
                console.log("Fetching inquirires.....");
    ...
    return (
        <>
            <div className={s.headerContainer}>
                <h1 className={s.headerTitle}>Platform Inquirires</h1>
                ...
                {inquiries.length === 0 && (
                    <div className={s.emptyState}>
                        ...
                        <p className={s.emptyText}>
                            There are no inquiries on the platform yet.
                        </p>
                    </div>
                )}
            </div>
