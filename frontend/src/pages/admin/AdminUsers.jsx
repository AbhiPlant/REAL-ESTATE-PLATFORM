...
import { HiOutlineFilter, HiOutlineIdentification, HiOutlineLockClosed, HiOutlineLockOpen, HiOutlineMail, HiOutlinePhone, HiOutlineTrash } from "react-icons/hi";
                                ...
                                filteredUsers.map((user) => (
                                    <tr key={user._id} className={s.tableRow}>
                                        <td className={s.tdUserInfo}>
                                            <div className='flex items-center rap-4'>
                                        ...
                                        <td className={s.tdActions}>
                                            <div className={s.actionsWrapper}>
                                                ...
                                                className={s.deleteButton} title='Delete User'>
