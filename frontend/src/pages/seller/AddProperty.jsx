            ...
            <div className={s.innerContainer}>
                <div className={s.header}>
                    ...
                    <p className={s.subheading}>
                        Fill in the details below to reach thousands of potential buyer.
                    </p>
                </div>
                        ...
                        <div className={s.contentGroupLarge}>
                            <div>
                                ...
                                <input type="text" name='title' value={formData.title}
                                    onChange={handleInputChange} placeholder='e.g Luxury 3BHK Apartment in Downtown'
                                    className={s.input} required />
                            </div>
                            <div>
                                <label className={s.label}>Detailed Description</label>
                                <textarea name="description" value={formData.description}
                                    onChange={handleInputChange} placeholder='Describe the property highlights...'
                                    className={`${s.input} ${s.textarea}`} required>
                                </textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className={s.contentGroupSmall}>
                                ...
                                <div className={s.gridTwoCol}>
                                    <div>
                                        ...
                                        <input type="text" name='city' value={formData.city}
                                            onChange={handleInputChange} placeholder='e.g. Mumbai' className={s.input}
                                            required />
                                    </div>
                                    <div>
                                        <label className={s.labelSmallMargin}>Pincode</label>
                                        <input type="text" name='pincode' value={formData.pincode}
                                            onChange={handleInputChange} placeholder='e.g. 400001' className={s.input}
                                            required />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name='area' value={formData.area}
                                        onChange={handleInputChange} placeholder='e.g. Worli' className={s.input}
                                        required />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className={s.section}>
                        ...
                        <div className={s.amenitiesGrid}>
                            {commonAmenities.map((amenity) => (
                                ...
                                ${formData.amenities.includes(amenity) ? s.amenityLabelActive
                                ...
                                >
                                    ...
                                    <span className={`${s.amenityTextBase} ${formData.amenities.includes(amenity) ?
                                            s.amenityTextActive : s.amenityTextInactive
                                        }`}>
                                        {amenity}
                                    </span>
                                </label>
                            ...
                            <div className={s.previewsGrid}>
                                ...
                                {images.length < 10 && (
                                    <div className={s.addMoreBox}>
                                        <input type="file" multiple onChange={handleImageChange}
                                            className='absolute inset-s-0 opacity-0 cursor-pointer'
                                            accept='image/*'
                                        />
