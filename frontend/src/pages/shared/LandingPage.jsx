      ...
      <section className={s.heroSection}>
        <div className={s.heroContent}>
          ...
          <p className={s.heroSubtitle}>
            ...
            listings, connect with top agents, and find a place you'll love.
          </p>
          ...
          <form onSubmit={handleSearch} className={s.searchForm}>
            <div className={s.searchField}>
              ...
              <div className={s.flexCol}>
                ...
                <input type="text" placeholder='Where are you looking?' value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)} className={s.inputTransparent} />
              </div>
            </div>
          ...
          <div className={s.statsContainer}>
            ...
            <div className={s.statItemBorder}>
              ...
              <p className={s.statLabel}>Agents Network</p>
            </div>
            <div className={s.statItemBorder}>
        ...
        <div className={s.heroImageContainer}>
          <div className={s.imageWrapper}>
            ...
            <div className={s.verifiedBadge}>
              ...
              <div>
                <h4 className={s.badgeTitle}>Verififed Listing</h4>
          ...
          <div className={s.categoryHeader}>
            <div className={s.categoryHeaderText}>
              ...
              <p className={s.categoryDesc}>
                Explore curetd collection of properties tailored to your specific
                lifestyle and needs.
              </p>
            </div>
          </div>
      ...
      <section className={s.featuredSection}>
        <div className={s.featuresContainer}>
          ...
          <div className={s.featuresContent}>
            <h2 className={s.featuresHeading}>Why RealEstate <br />
        ...
        <div className={s.container}>
          <div className={s.footerMainGrid}>
            ...
            <div>
              ...
              <p className={s.newsletterDesc}>
                Subscribes to get the latest listings and market insights
          ...
          <div className={s.bottomBar}>
            <div className={s.bottomBarFlex}>
              <p>
                &copy; {new Date().getFullYear()} RealEstate. All righs reserved.
              </p>
            ...
            <div className={s.designCredit}>
              ...
              <a href="#" target='_blank' className={s.designLink}>Abhishek Digital Service</a>
            </div>
          </div>
        </div>
      </footer> 
