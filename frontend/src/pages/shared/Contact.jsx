...
const Contact = () => {
    ...
    // to submit the data to the server side
                            ...
                            <form onSubmit={handleSubmit} className={s.form}>
                                <div className={s.formTwoColGrid}>
                                    <div className={s.inputGroup}>
                                        ...
                                        <input type="text" name='name' required value={formData.name}
                                            onChange={handleChange} placeholder='John Doe' className={s.input} />
                                    </div>
                                    <div className={s.inputGroup}>
                                        <label className={s.label}>
                                        ...
                                        <input type="email" name='email' required value={formData.email}
                                            onChange={handleChange} placeholder='John@example.com' className={s.input} />
                                    </div>
                                </div>
                                ...
                                <div className={s.inputGroup}>
                                    ...
                                    <input type="tel" name='phone' required value={formData.phone}
                                        onChange={handleChange} placeholder='+1 234 567 89' className={s.input} />
                                </div>
                                ...
                                <div className={s.inputGroup}>
                                    ...
                                    rows="5" className={`${s.input} ${s.textarea}`}>
                                    </textarea>
                                </div>
