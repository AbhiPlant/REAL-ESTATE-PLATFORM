...
const ChatMessages = () => {
    ...
    // updating the chat when new messages is received
    useEffect(() => {
        if (socket) {
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            ...
            if (res.data.newMessage) {
                ...
                //console.log("NEW MESSAGE:", res.data.newMessage);
                sendMessage(
                    activeChat._id,
                    textToSend,
    ...
    const handleDeleteMessage = async (chatId, messageId) => {
        if (!window.confirm("Delete this messaage")) return;
                    ...
                    <div className={s.sidebarContent}>
                        {conversations.length === 0 ? (
                            ...
                            conversations.map((chat) => (
                                <div key={chat._id} className={`${s.conversationItem} ${activeChat?._id === chat._id ? s.conversationItemActive : ""
